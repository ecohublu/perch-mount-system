...
class Projects(flask_restful.Resource):
    def get(self):
        projects = perchai_service.projects.get_projects()
        return [project.to_dict() for project in projects]


class Cameras(flask_restful.Resource):
    def get(self):
